        ...
        <div class="col-md-12">
            ...
            <div class="card">
                <div class="card-header card-header-primary">
                    <h4 class="card-title">Kitabı Düzenle</h4>
                    <p class="card-category">{{$data[0]['name']}}</p>

                </div>
                <div class="card-body">
                    <form action="{{route('admin.kitap.update',['id'=>$data[0]['id']])}}" method="post">
                        @csrf
                        <div class="row">
                            <div class="col-md-12">
                        ...
                        <button type="submit" class="btn btn-primary pull-left">Kitabı Düzenle</button>
